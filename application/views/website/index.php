...
s1.async=true;
s1.src='https://embed.tawk.to/5d1df4e622d70e36c2a42158/default';
s1.charset='UTF-8';
                        ...
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12 col-md-10 col-lg-9">
                                ...
                                <div class="d-none d-sm-block">
                                  ...
                                  <a href="<?php echo base_url(); ?>Start-Will" class="btn active akame-btn2" data-animation="fadeInUp" data-delay="700ms">Make Your Will</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12 col-md-10 col-lg-9">
                                ...
                                <div class="d-none d-sm-block">
                                  <a href="<?php echo base_url(); ?>About-Us" class="btn active akame-btn" data-animation="fadeInUp" data-delay="700ms">About Us</a>
                                  <a href="<?php echo base_url(); ?>Register" class="btn active akame-btn2" data-animation="fadeInUp" data-delay="700ms">Register</a>
                                </div>
                                </div>
                        </div>
                    </div>
                        ...
                        <p>“The object of Wills according to the tradition of the Prophet is to provide for the maintenance of
                           members of family and other relatives where they cannot be properly provided for by the law of inheritance.
                            At the same time the prophet has declared that the power should not be exercised to the injury of the lawful
                             heirs.. ”</p>
                             <div class="row">
                               <div class="col-6 no-m-padding pl-0">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-service-area  mb-80 wow fadeInUp" data-wow-delay="200ms">
                        <svg version="1.1" id="Layer_1" width="70px" height="70px" viewBox="0 0 84 84.003">
                          <g>
                          	...
                          	<linearGradient id="SVGID_2_" gradientUnits="userSpaceOnUse" x1="42" y1="83.4279" x2="42" y2="0.575">
                          		<stop  offset="0" style="stop-color:#0D5294"/>
                          		<stop  offset="1" style="stop-color:#0F9C96"/>
                          	</linearGradient>
                        ...
                        <h5 class="pt-3">Fill Your Information</h5>
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-service-area mb-80 wow fadeInUp" data-wow-delay="400ms">
                        ...
                        <svg width="70" height="70" viewBox="0 0 84 84.003">
                          <g>
                        ...
                        <h5 class="pt-3">Verify Your Information </h5>
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-service-area mb-80 wow fadeInUp" data-wow-delay="600ms">
                        ...
                        <svg width="70px" height="70px" viewBox="0 0 84 84.003">
                          <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="42" y1="83.4279" x2="42" y2="0.575">
                          	<stop  offset="0" style="stop-color:#0D5294"/>
                          	<stop  offset="1" style="stop-color:#0F9C96"/>
                          </linearGradient>
                        ...
                        <h5 class="pt-3">Download Your Will</h5>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6">
                    ...
                    <div class="choose-us-content mt-30 mb-80">
                        <ul>
                            <li><i class="check-square-o"></i> Our Website Leads To a More Balanced and Optimistic Outlook On Using Online Websites.</li>
                            <li><i class="check-square-o"></i> Our websites is trust worthy and experienced service provider.</li>
                            <li><i class="check-square-o"></i> Efficient and professional support.</li>
                            <li><i class="check-square-o"></i> Independent professional advices available.</li>
                            <li><i class="check-square-o"></i> We assure our users availability of Quality product to our users.</li>
                            <li><i class="check-square-o"></i> Independent professional advices available</li>
                            <li><i class="check-square-o"></i> Trusted advice and assistants provided.</li>
                        </ul><br>
                        <div class="row">
                          <div class="col-6 no-m-padding">
                            <a href="<?php echo base_url(); ?>Benefits/#benefit" class="btn akame-btn mt-30" style="padding: 0 15px !important;">Read More</a>
                          </div>
                          <!-- <div class="col-6 no-m-padding d-none d-sm-block">
                              <a href="<?php echo base_url(); ?>Start-Will" class="btn akame-btn2 active mt-30 "style="padding: 0 8px !important;font-size: 13px;">Start your Will</a>
                          </div> -->
                        </div></div>
                </div>
            </div>
                ...
                <div class="col-10">
                    <div class="testimonial-slides owl-carousel ">
                        ...
                        <div class="single-testimonial-slide">
                          <div class="testimonial_icon mb-5">
