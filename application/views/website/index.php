                        ...
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12 col-md-9 col-lg-6">
                                <div class="welcome-text">
                                  ...
                                  <p data-animation="fadeInUp" data-delay="400ms">“At the end of the day the golas are simple safety and security”</p>
                                    <a href="<?php echo base_url(); ?>About-Us" class="btn active akame-btn" data-animation="fadeInUp" data-delay="700ms">About Us</a>
                                      <a href="#" class="btn active akame-btn" data-animation="fadeInUp" data-delay="700ms">Make Your Will</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="section-heading mb-80">
                        <h2>Islamic will</h2>
                        <!-- <p>To control how your estate is divided. To appoint guardians to look after your children or your dependants. Your will can direct the smooth transition of your assets. Minimize tensions among survivors. If you wish to leave your assets to an institution or organization or charity, a will can see that your wishes are carried out. To ensure your properties are distributed as your wishes. </p> -->
                        <span>About Us</span>
                    </div>
                </div>
                <!-- About Us Thumbnail -->
                        ...
                        <p>“The object of Wills according to the tradition of the Prophet is to provide for the maintenance of
                           members of family and other relatives where they cannot be properly provided for by the law of inheritance.
                            At the same time the prophet has declared that the power should not be exercised to the injury of the lawful
                             heirs.. ”</p>
                        <a href="<?php echo base_url(); ?>About-Us" class="btn akame-btn active mt-30">Read More</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-12 col-lg-6">
                    ...
                    <div class="choose-us-content mt-30 mb-80">
                        <ul>
                            ...
                            <!-- <li><i class="fa fa-check-square-o" aria-hidden="true"></i> Cost efficient documentation, user friendly instructions and checklist to avoid confusion</li> -->
                        </ul>
                          <a href="<?php echo base_url(); ?>About-Us" class="btn akame-btn active mt-30">Read More</a>
                    </div>
                </div>
                ...
                <div class="col-10">
                    <div class="testimonial-slides owl-carousel ">
                        ...
                        <div class="single-testimonial-slide">
                          ...
                          <div class="row">
                            <div class="col-md-2 testimonial_img " alt="" >
                            <img src="<?php echo base_url(); ?>assets/website/img/bg-img/users.png" alt="" >
                            </div>
                            <div class="col-md-10">
                        ...
                        <div class="single-testimonial-slide">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-10">
                              <p>	6.	I have had a wonderful experience being represented wasiat.com They were able to resolve the situation through diligent hard work.
