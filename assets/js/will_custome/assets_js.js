$(document).ready(function(){
  ...
  function real_estate_table(will_id){
  ...
  function bank_assets_table(will_id){
  ...
  function vehicle_assets_table(will_id){
    // get and fill up Vehicle...
  ...
  function gift_assets_table(will_id){
  ...
  var table_bank_assets = bank_assets_table(will_id);
  var table_real = real_estate_table(will_id);
  var table_vehicle = vehicle_assets_table(will_id);
  var table_gift2 = gift_assets_table(will_id);
